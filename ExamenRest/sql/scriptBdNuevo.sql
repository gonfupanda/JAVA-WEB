...
-- -----------------------------------------------------
-- -----------------------------------------------------
-- Schema gestiondocente
-- -----------------------------------------------------

-- -----------------------------------------------------
-- Schema gestiondocente
-- -----------------------------------------------------
CREATE SCHEMA IF NOT EXISTS `gestiondocente` DEFAULT CHARACTER SET utf8 COLLATE utf8_bin ;
USE `gestiondocente` ;

-- -----------------------------------------------------
-- Table `gestiondocente`.`alumno`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gestiondocente`.`alumno` (
...
-- -----------------------------------------------------
-- Table `gestiondocente`.`cliente`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gestiondocente`.`cliente` (
...
-- -----------------------------------------------------
-- Table `gestiondocente`.`profesor`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gestiondocente`.`profesor` (
  `codigo` INT NOT NULL AUTO_INCREMENT,
...
-- -----------------------------------------------------
-- Table `gestiondocente`.`curso`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gestiondocente`.`curso` (
  `codigo` INT NOT NULL AUTO_INCREMENT,
  ...
  CONSTRAINT `fk_curso_cliente_codigo`
    ...
    REFERENCES `gestiondocente`.`cliente` (`codigo`),
  CONSTRAINT `fk_curso_profesor_codigo`
    FOREIGN KEY (`profesor_codigo`)
    REFERENCES `gestiondocente`.`profesor` (`codigo`))
ENGINE = InnoDB
AUTO_INCREMENT = 5
DEFAULT CHARACTER SET = utf8
COLLATE = utf8_bin;
...
-- -----------------------------------------------------
-- Table `gestiondocente`.`imparticion`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `gestiondocente`.`imparticion` (
  `codigo` INT NOT NULL AUTO_INCREMENT,
